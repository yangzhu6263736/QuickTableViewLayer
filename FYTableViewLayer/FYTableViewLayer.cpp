...
FYTableViewLayer::FYTableViewLayer(void):
_tableView(NULL)
{
...
void FYTableViewLayer::setTableViewLayerSize(CCSize size)
{
...
void FYTableViewLayer::setTableViewPriority(int priorty)
{
...
void FYTableViewLayer::tableCellTouched(CCTableView* table, CCTableViewCell* cell)
{
...
CCSize FYTableViewLayer::cellSizeForTable(CCTableView *table)
{
	if (kScriptTypeNone != m_eScriptType)
	{
...
CCTableViewCell* FYTableViewLayer::tableCellAtIndex(CCTableView *table, unsigned int idx)
{
	if (kScriptTypeNone != m_eScriptType)
	{
...
unsigned int FYTableViewLayer::numberOfCellsInTableView(CCTableView *table)
{
	if (kScriptTypeNone != m_eScriptType)
	{
...
void FYTableViewLayer::scrollViewDidScroll(CCScrollView* view)
{
	if (kScriptTypeNone != m_eScriptType)
	{
...
void FYTableViewLayer::scrollViewDidZoom(CCScrollView* view)
{
	if (kScriptTypeNone != m_eScriptType)
	{
